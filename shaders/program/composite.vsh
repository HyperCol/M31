...
void main() {
    ...
    SkyLightingColor    = max(vec3(0.0), 1.0 - CalculateLocalInScattering(samplePosition, worldUpVector)) * mix(sum3(SunLightingColor) + sum3(MoonLightingColor), 1.0, NoLight_Luminance);
