...
void main() {
    ...
    SkyLightingColor    = max(vec3(0.0), 1.0 - CalculateLocalInScattering(samplePosition, worldUpVector)) * (sum3(SunLightingColor) + sum3(MoonLightingColor) + No_Nature_Light_Luminance);
