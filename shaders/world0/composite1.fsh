...
void main() {
    ...
    */
    ...
    float depthWeight = (abs(ExpToLinerDepth(texture(colortex11, previousCoord).a) - v0.linearDepth) - 0.01) * 1.0;
    float velocityWeight = length(velocity * resolution) * 0.0001;
